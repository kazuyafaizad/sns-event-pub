    ...
    <JetAuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <JetInput id="phone_number" v-model="form.phone_number" type="text" class="mt-1 block w-full" required
            ...
            <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature" class="mt-4">
                <JetLabel for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the
                            <a target="_blank" :href="route('terms.show')" class="underline text-sm">Terms of
                                Service</a>
                            and
                            <a target="_blank" :href="route('policy.show')" class="underline text-sm">Privacy Policy</a>
                        </div>
                    </div>
                </JetLabel>
            </div>
            ...
            <div class="flex flex-col items-center justify-end mt-4">
                ...
                <Link :href="route('login')" class="underline text-sm mt-4">
                Already registered?
                </Link>
            </div>
        </form>
