    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <JetFormSection @submitted="addTeamMember">
                ...
                <template #actions>
                    ...
                    <JetButton :class="{ 'loading mr-2': addTeamMemberForm.processing }"
                    ...
                    <div class="space-y-6">
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button v-if="userPermissions.canAddTeamMembers && availableRoles.length"
                                ...
                                <!-- Leave Team -->
                                <button v-if="$page.props.user.id === user.id"
        ...
        <JetDialogModal :show="currentlyManagingRole" @close="currentlyManagingRole = false">
            ...
            <template #footer>
                ...
                <JetButton class="ml-3" :class="{ 'loading mr-2': updateRoleForm.processing }"
        ...
        <JetConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            ...
            <template #footer>
                ...
                <JetDangerButton class="ml-3" :class="{ 'loading mr-2': leaveTeamForm.processing }"
        ...
        <JetConfirmationModal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
            ...
            <template #footer>
                ...
                <JetDangerButton class="ml-3" :class="{ 'loading mr-2': removeTeamMemberForm.processing }"
