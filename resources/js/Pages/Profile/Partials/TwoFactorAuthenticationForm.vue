            ...
            <div class="mt-5">
                <div v-if="!twoFactorEnabled">
                    <JetConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <JetButton type="button" :class="{ 'loading mr-2': enabling }" :disabled="enabling">
                            Enable
                        </JetButton>
                    </JetConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <JetConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <JetButton v-if="confirming" type="button" class="mr-3" :class="{ 'loading mr-2': enabling }"
                            :disabled="enabling">
                            Confirm
                        </JetButton>
                    </JetConfirmsPassword>
                    ...
                    <JetConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <JetSecondaryButton v-if="confirming" :class="{ 'loading mr-2': disabling }"
                            :disabled="disabling">
                            Cancel
                        </JetSecondaryButton>
                    </JetConfirmsPassword>
                    ...
                    <JetConfirmsPassword @confirmed="disableTwoFactorAuthentication">
                        <JetDangerButton v-if="!confirming" :class="{ 'loading mr-2': disabling }"
                            :disabled="disabling">
                            Disable
                        </JetDangerButton>
                    </JetConfirmsPassword>
